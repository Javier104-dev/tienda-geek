...
const crearDiv = (nombre, precio, id) =>{
    ...
    `
        <div class="categorias__contenedor__foto">
            ...
            <img class="foto__producto" src="assets/Imagenes/sta-war/taza.jpg" alt="taza star-war">
        </div>
...
productosServices.listaProductos().then((productos)=>{ //la promesa ahora es data osea el JSON
    productos.forEach((producto) => {
        const nuevoDiv = crearDiv(producto.nombre, producto.precio)
